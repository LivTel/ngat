...
/** OSS COMMAND: ADD_INST_CONFIG.<br>
 ...
 * <br>
 */
public class ADD_INST_CONFIG extends TRANSACTION {

	// Constants.

	/** Constant: Indicates The Specified InstConfig already exists*/
	...
	/** Create a ADD_INST_CONFIG with specified id.
	 * @param id The unique id of this ADD_INST_CONFIG.
	 */
	public ADD_INST_CONFIG(String id) { super(id); }

	/** Create a ADD_INST_CONFIG with specified id and parameters.
	 * @param id The unique id of this ADD_INST_CONFIG.
