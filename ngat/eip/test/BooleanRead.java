// BooleanRead.java
// $Header: /space/home/eng/cjm/cvs/ngat/eip/test/BooleanRead.java,v 1.2 2009-02-05 11:33:57 cjm Exp $
...
/**
 * This class tests the  ngat.eip library, by reading a boolean value from a PLC.
...
public class BooleanRead
{
	 ...
	 */
	public final static String RCSID = new String("$Id: BooleanRead.java,v 1.2 2009-02-05 11:33:57 cjm Exp $");
	/**
	...
	/**
	 * The PLC address of the integer to read. i.e. N7:1/1.
	 */
	 ...
	 * <li>Calls setLogFilterLevel with the logLevel.
	 * <li>Calls getBoolean with plcAddress to get the value held at the specified address on the PLC.
	...
	public void run() throws EIPNativeException
	{
		...
		try
		{
			value = plc.getBoolean(handle,plcAddress);
	 ...
	 * Example run: 
	 * <pre>java ngat.eip.test.BooleanRead -ip 150.204.240.114 -backplane 1 -slot 0 -plc_address N7:1/1</pre>
	 * <ul>
	...
	{
		BooleanRead ir = new BooleanRead();
