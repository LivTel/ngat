// BooleanWrite.java
// $Header: /space/home/eng/cjm/cvs/ngat/eip/test/BooleanWrite.java,v 1.1 2008-10-09 14:14:27 cjm Exp $
...
/**
 * This class tests the ngat.eip library, by writing a boolean value to a PLC.
...
public class BooleanWrite
{
	 ...
	 */
	public final static String RCSID = new String("$Id: BooleanWrite.java,v 1.1 2008-10-09 14:14:27 cjm Exp $");
	/**
	...
	/**
	 * The PLC address of the integer to write. i.e. N7:1/1.
	 */
	 ...
	 * <li>Calls setLogFilterLevel with the logLevel.
	 * <li>Calls setBoolean with plcAddress to set the value held at the specified address on the PLC.
				...
				if((i+1)< args.length)
				{
					...
					else
					{
						throw new IllegalArgumentException(this.getClass().getName()+
							   ":parseArguments:Value not a valid boolean:"+args[i+1]);
					}
					i++;
				}
				else
	...
	private void help()
	{
		...
		System.out.println("\t-value|-v <true|false>");
		System.out.println("\t<address> is of the form N7:1/1.");
	}

	/**
	 * Main method - entry point for the test program.
	 * Example run: 
	 * <pre>java ngat.eip.test.BooleanWrite -ip 150.204.240.114 -plc_address N7:1/1 -value true -backplane 1 -slot 0 </pre>
	 * <ul>
	...
	{
		BooleanWrite ir = new BooleanWrite();
