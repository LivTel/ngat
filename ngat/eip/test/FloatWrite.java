...
public class FloatWrite
{
	 ...
	 * <li>Calls setLogFilterLevel with the logLevel.
	 * <li>Calls setFloat with plcAddress to set the value held at the specified address on the PLC.
	...
	public void run() throws EIPNativeException
	{
		...
		try
		{
			plc.setFloat(handle,plcAddress,value);
	 ...
	 * Example run: 
	 * <pre>java ngat.eip.test.FloatWrite -ip 150.204.240.114 -plc_address F8:1 -value 1.1 -backplane 1 -slot 0 </pre>
	 * <ul>
