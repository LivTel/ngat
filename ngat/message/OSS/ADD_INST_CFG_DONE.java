...
/** OSS COMMAND_DONE: ADD_INST_CFG_DONE.<br>
 ...
 * <br>
 */
public class ADD_INST_CFG_DONE extends TRANSACTION_DONE {

	/** Create a ADD_INST_CFG_DONE with specified id.
	 * @param id The unique id of this ADD_INST_CFG_DONE.
	 */
	public ADD_INST_CFG_DONE (String id) { super(id); }

	// Hand generated code.

} // class def. [ADD_INST_CFG_DONE].
