 ...
 * <br>
 */
public class ADD_TELE_CFG extends TRANSACTION {
	...
	/** Create a ADD_TELE_CFG with specified id.
	 * @param id The unique id of this ADD_TELE_CFG.
	 */
	public ADD_TELE_CFG(String id) { super(id); }

	/** Create a ADD_TELE_CFG with specified id and parameters.
	 * @param id The unique id of this ADD_TELE_CFG.
