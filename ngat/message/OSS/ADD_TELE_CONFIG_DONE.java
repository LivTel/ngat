...
/** OSS COMMAND_DONE: ADD_TELE_CONFIG_DONE.<br>
 ...
 * <br>
 */
public class ADD_TELE_CONFIG_DONE extends TRANSACTION_DONE {

	/** Create a ADD_TELE_CONFIG_DONE with specified id.
	 * @param id The unique id of this ADD_TELE_CONFIG_DONE.
	 */
	public ADD_TELE_CONFIG_DONE (String id) { super(id); }
...
} // class def. [ADD_TELE_CONFIG_DONE].
