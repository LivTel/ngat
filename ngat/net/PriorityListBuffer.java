 ...
 * <br><br>
 */
public class PriorityListBuffer {
    ...
    public PriorityListBuffer(int numLevels) {
	this.numLevels = (numLevels > 0 ? numLevels : 1);
	queue = new Vector[numLevels];
	...
	if (isEmpty())
	    throw new InterruptedIOException("PriorityListBuffer timed out waiting:");
    }
