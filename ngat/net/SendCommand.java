...
public class SendCommand {
    ...
    public void asynchSend(final COMMAND command, final JMSResponseHandler handler) throws Exception {

	Runnable r = new Runnable() {
		public void run() {
		    try {
			COMMAND_DONE done = sendCommand(command);
			handler.commandDone(done);
		    } catch (Exception e) {
			handler.commandException(e);
		    }
		}
	    };
