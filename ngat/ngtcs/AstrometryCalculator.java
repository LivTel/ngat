...
public abstract class AstrometryCalculator
{
	...
	new String( "$Id: AstrometryCalculator.java,v 1.1 2003-07-01 10:11:30 je Exp $" );
     ...
     */
    public final double RADS2SECS = ( 43200.0 / Math.PI );

    /**
     * Conversion factor from sidereal seconds to atomic seconds.
     */
    public final double SIDEREAL2ATOMIC = 1.00273790935;
