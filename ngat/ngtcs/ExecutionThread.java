...
public class ExecutionThread extends Thread
{
	...
	new String( "$Id: ExecutionThread.java,v 1.1 2003-07-01 10:11:30 je Exp $" );
	...
	Class argClasses[] = 
	{
	    ExecutionThread.class, Telescope.class, Command.class
	};

	Object args[] =
	{
	    this, telescope, command
	};
	...
	clazz = Class.forName( root+".execute."+leaf+"Implementor" );
 ...
 *      $Id: ExecutionThread.java,v 1.1 2003-07-01 10:11:30 je Exp $
