...
public class LoggingInitialiser
{
   ...
   */
  public static int NGTCS_MULTICAST_PORT = 35535;

  /**
   * Default group name for NGTCS multicast logging.
   */
  public static String NGTCS_MULTICAST_GROUP_NAME = "NGTCS logging";

  /**
   * Default directory for NGTCS file logging.
   */
  public static String NGTCS_LOGGING_DIRECTORY = "logs";

  /**
   * Default maximum log level for NGTCS logging.
   */
  public static int NGTCS_MAX_LOG_LEVEL = 5;
    ...
    throws InitialisationException
  {
	...
	( "logHandler"+( handlerList.size() + 1 ) );
      String formatterClassName = np.getProperty
	( "logFormatter"+( handlerList.size() + 1 ) );
