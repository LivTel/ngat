...
/**
 * The TRACK command is implemented by setting all necessary states and
    ...
    implements java.lang.Runnable
{
    ...
    /**
     * The TRACKImplementor is instantiated. This sets the telescope state to
     * IDLE to stop any other TRACK commands.
     */
    public TRACKImplementor( ExecutionThread eT, Telescope ts, Command c )
    {
	super( eT, ts, c );
	...
	// set old and new time position so that TRACK is not obtained
	...
	System.err.println( "starting TRACK thread..." );
	...
	while( ( nAck < 50 ) && ( t.isAlive() ) )
		...
		// if TRACK is OK for 3 seconds return success
	...
	if( nAck >= 50 )
	    ...
	    returnMessage = "TRACK thread has mysteriously died";
    ...
    /**
     * The TRACK thread. This thread executes a while loop under conditional
...
/*
 *    $Date: 2003-07-02 11:10:41 $
 * $RCSfile: TRACKImplementor.java,v $
 *  $Source: /space/home/eng/cjm/cvs/ngat/ngtcs/command/execute/TRACKImplementor.java,v $
