...
public class BasicMechanism
    implements PluggableSubSystem, ControllableSubSystem
{
    /**
     * String used to identify RCS revision details.
     */
    public static final String RevisionString =
	new String( "$Id: BasicMechanism.java,v 1.1 2003-07-01 10:13:46 je Exp $" );
     ...
     */
    protected SubSystemState mechanismState = SubSystemState.INACTIVE;
    ...
    {
	mechanismState = SubSystemState.INACTIVE;
    }
     ...
     */
    public State getSubSystemState()
    {
	return (State)mechanismState;
    }
	...
	try
	    ...
	    {
		throw new InitialisationException( "Could not get "+logName+
						   " properties because: "+e );
	    }
    }
 ...
 *      $Id: BasicMechanism.java,v 1.1 2003-07-01 10:13:46 je Exp $
