...
// $Header: /space/home/eng/cjm/cvs/ngat/phase2/PolarimeterConfig.java,v 1.1 2006-11-20 14:51:23 cjm Exp $
package ngat.phase2;
...
public class PolarimeterConfig extends InstrumentConfig implements Serializable
{
	 ...
	 */
	public final static String RCSID = new String("$Id: PolarimeterConfig.java,v 1.1 2006-11-20 14:51:23 cjm Exp $"); 
	/** 
	...
	return "PolarimeterConfig: "+name+", Bin ["+detectors[0].getXBin()+", "+detectors[0].getYBin()+"]";
    }
