...
/** 
 * Subclass of Detector to represent the Raptor Ninox-640 IR Detector.
 * This is an InGaAS sensor with wavelength range 400-1700nm, 640 x 512 pixels (15um x 15um pixel size).
 */
public class RaptorDetector extends Detector implements Serializable
{
	/**
	 ...
	 */
	public static final String name = "Raptor Ninox-640";
	/**
	...
	/**
	 * Create a RaptorDetector.
	 */
	public RaptorDetector()
	{
		super();
	}
	...
	{
		out.println(tab(level)+"<RaptorDetector name= '"+name+"'>");
		...
		out.println(tab(level)+"</RaptorDetector>");
	}
}
